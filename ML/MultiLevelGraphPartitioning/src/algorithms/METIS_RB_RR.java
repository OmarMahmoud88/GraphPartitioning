...
import refinement.FMRefinement_Locked;
...
/*METIS Recursive Bisection, Relative Refinement*/
public class METIS_RB_RR {
	...
	public METIS_RB_RR(Graph graph, int numberOfPartitions, Class<Object> coarseningClass,
	...
	private PartitionGroup initialPartition(Graph cGraph, int numberOfPartitions)
		...
		if (numberOfPartitions == 2) {
			...
			METIS_RB_RR mRB = new METIS_RB_RR(cGraph, 2, this.coarseningClass, this.partitioningClass, 4,
					this.imbalanceRatio, 1, 10, 1, 10, -10000);
			...
			mRB = new METIS_RB_RR(subGraph1, this.numberOfPartitions / 2, this.coarseningClass, this.partitioningClass,
					4, this.imbalanceRatio, 1, 10, 1, 10, -10000);
			...
			mRB = new METIS_RB_RR(subGraph2, this.numberOfPartitions / 2, this.coarseningClass, this.partitioningClass,
					4, this.imbalanceRatio, 1, 10, 1, 10, -10000);
	...
	private PartitionGroup refinePartitions(Graph gr, PartitionGroup parts) {
		...
		FMRefinement_Locked fMR = new FMRefinement_Locked(gr, null, refinedParts, this.refinementIterations,
				levelImbalance);
	...
	private PartitionGroup lastRefinePartitions(Graph gr, PartitionGroup parts) {
		...
		FMRefinement_Locked fm = new FMRefinement_Locked(gr, null, parts, this.finalRefinementIterations,
				this.imbalanceRatio);
