...
public class FMRefinement_Locked {
	private Graph graph;
	...
	public FMRefinement_Locked(Graph graph, RandomAccessIntHashSet graphSubset, PartitionGroup partsGroup,
			int iterations, float imbalanceRatio) {
		// assign attributes
		this.graph = graph;
		this.maxTransfers = this.graph.getNumberOfNodes();
		this.minGainAllowed = -10000;
		this.iterations = iterations;
		this.numberOfTransfersApplied = 0;
		this.lockedNodes = new IntFixedSizeHashSet(this.maxTransfers / 4);
		this.maxNonPositiveSwaps = this.maxTransfers / 10;
