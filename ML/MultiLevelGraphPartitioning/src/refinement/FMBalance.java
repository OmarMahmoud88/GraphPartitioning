...
public class FMBalance {
	...
	public FMBalance(Graph graph, RandomAccessIntHashSet graphSubset, PartitionGroup partsGroup, int maxSwaps,
	...
	private void refinePartitions() {
		...
		// if maxTransfers = -1, that means continue till the partitions are
		// balanced
		while ((this.maxTransfers == -1 && this.refinedPartitions.getPartitionImbalance() > (1 + this.imbalanceRatio))
				|| this.numberOfTransfersApplied < this.maxTransfers) {
