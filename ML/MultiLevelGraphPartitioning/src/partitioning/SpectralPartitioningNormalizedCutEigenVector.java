...
public class SpectralPartitioningNormalizedCutEigenVector extends Partitioning {

	private int eigIndex = 1;

	public SpectralPartitioningNormalizedCutEigenVector(Graph graph, int numberOfPartitions, int numberOfTrials, float imbalanceRatio) {
